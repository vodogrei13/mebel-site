          ...
          <div className={css.cards}>
            <div className={css.card}>
                <div className={css.card__container}>
                    ...
                    <div className={css.cards_image}>
                        <img src="/png/dveri-kupe/standart.png" alt='Двери-купе "Стандарт"'/>
                    </div>
                </div>
            </div>
            ...
            <div className={css.card}>
                <div className={css.card__container}>
                    ...
                    <div className={css.cards_image}>
                        <img src="/png/dveri-kupe/Eco.png" alt='Двери-купе "Стандарт"'/>
                    </div>
                </div>
            </div>
            ...
            <div className={css.card}>
                <div className={css.card__container}>
                    ...
                    <div className={css.cards_image}>
                        <img src="/png/dveri-kupe/bravo.png" alt='Двери-купе "Стандарт"'/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className={css.cards}>
            <div className={css.card}>
                <div className={css.card__container}>
                    ...
                    <div className={css.cards_image}>
                        <img src="/png/dveri-kupe/nova.png" alt='Двери-купе "Стандарт"'/>
                    </div>
                </div>
            </div>
            ...
            <div className={css.card}>
                <div className={css.card__container}>
                    ...
                    <div className={css.cards_image}>
                        <img src="/png/dveri-kupe/slim-line.png" alt='Двери-купе "Стандарт"'/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div className={css.cards}>
            <div className={css.card}>
                <div className={css.card__container}>
                    ...
                    <div className={css.cards_image}>
                        <img src="/png/dveri-kupe/4in1.png" alt='Двери-купе "Стандарт"'/>
                    </div>
                </div>
            </div>
            ...
            <div className={css.card}>
                <div className={css.card__container}>
                    ...
                    <div className={css.cards_image}>
                        <img src="/png/dveri-kupe/grace.png" alt='Двери-купе "Стандарт"'/>
                    </div>
                </div>
            </div>
        </div>
