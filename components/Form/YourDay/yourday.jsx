"use client";
import css from "./yourday.module.scss";
...
useEffect(() => {
  ...
  style.innerHTML = `
    ...
    body.pdf-mode .${css.yourday__form_main},
  ...
  try {
    ...
    formData.append("formName", "фасадов Ваш день");
    ...
    <div className={css.yourday__container}>
      <section className={css.yourday__form_container}>
        <div className="pdf-adjust" ref={pdfRef}>
          <div className={css.yourday__logo}>
            <img src={`${basePath}/png/fasads/вашдень.png`} className={css.yourday__logo_item} alt="Логотип" />
          </div>

    <form className={css.yourday__form}>
          <div className={css.yourday__form_main}>
